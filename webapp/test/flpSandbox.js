		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tsigsapflightbooking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsigsapflightbooking-display": {
								"semanticObject": "tsigsapflightbooking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsig.sap.flightbooking",
									"url": sap.ui.require.toUrl("tsig/sap/flightbooking")
								}
							}
						}
					}
